...
public class CadProcessadorView implements Initializable {
	...
	@FXML
	void CadProduto_Action(ActionEvent event) {
		controller.cadProcessador(event, new Processador(Integer.parseInt(txtNucleos.getText()),
				Integer.parseInt(txtThreads.getText()), Double.parseDouble(txtPeso.getText()), txtNome.getText(),
