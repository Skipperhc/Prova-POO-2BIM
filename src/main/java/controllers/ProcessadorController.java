...
public class ProcessadorController {
	...
	public ProcessadorController(IProcessadorDAO processadorDAO) {
		dao = processadorDAO;
	}
	...
	public Processador buscarProcessador(int cod) {
		return dao.buscar(cod);
	}
	
	public void cadProcessador(ActionEvent event, Processador obj) {
		try {
	...
	public void editarProcessador(ActionEvent event, Processador obj) {
		try {
